...
#+BEGIN_SRC emacs-lisp
  (defhydra bman-cmd (:exit t :columns 2)
    ...
    ("i" ($run-bman "-s all +s collage.collage_assemble_gnrio_dft_sub_parition_1_lib,collage.collage_assemble_gnrio_dft_sub_parition_2_lib,collage.collage_assemble_gnrio_dft_sub_parition_3_lib,collage.collage_assemble_gnrio_dft_sub_parition_4_lib,collage.collage_assemble_gnrio_dft_sub_parition_5_lib,collage.collage_assemble_gnrio_dft_sub_parition_6_lib,collage.collage_assemble_gnrio_dft_sub_parition_7_lib,collage.collage_assemble_gnrio_dft_sub_parition_8_lib,collage.collage_assemble_gnrio_dft_sub_parition_9_lib,collage.collage_assemble_gnrio_dft_sub_parition_10_lib,collage.collage_assemble_gnrio_dft_insertion_lib,collage.collage_assemble_gnrio_dft_integration_pre_lib") "DFT integration")
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun $gatekeeper-env ()
    `("GK_EVENTTYPE=mock" "LD_LIBRARY_PATH"
