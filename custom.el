 ...
 '(safe-local-variable-values
   '((nameless-aliases ("ai" . "aidermacs")) (flycheck-mode . t) (verilog-typedef-regexp . "_[eus]$")
     ...
     (eval font-lock-add-keywords nil
           ...
           ((,(concat "("
                      (regexp-opt
                       '("sp-do-move-op" "sp-do-move-cl" "sp-do-put-op" "sp-do-put-cl"
                         "sp-do-del-op" "sp-do-del-cl")
                       t)
                      "\\_>")
     ...
     (rust-format-on-save . t) (eval require 'org-roam-dev) (org-src-preserve-indentation . t)
     (eval visit-tags-table (expand-file-name "TAGS" (vc-git-root default-directory)) t)
     (checkdoc-package-keywords-flag) (checkdoc-minor-mode . t) (cperl-close-paren-offset . -4)
     (cperl-indent-parens-as-block . t) (eval when (fboundp 'rainbow-mode) (rainbow-mode 1))
