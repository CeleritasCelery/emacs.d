...
use my standard up and down for evil ex history
#+BEGIN_SRC emacs-lisp
(general-define-key
...
need it
#+BEGIN_SRC emacs-lisp
  (ad-disable-advice 'compilation-find-file 'around 'projectile-compilation-find-file)
  ...
  (defvar ipgen-error-regexp-alist
    `((,(err-rx ^ "gmake: *** [" (group-n 1 (>= 10 any)) "] Error " num)
      ...
      (,(err-rx ^ "Information: script '" filename "'"
       ...
       1 2)
      (,(err-rx ^ "gmake[2]: *** [" filename "] Error " nums)
       $find-ult-log))
...
#+BEGIN_SRC emacs-lisp
  (use-package verilog-mode
    :straight nil
    :mode (rx "." (or "hier" "vf" "svh" "vg" "vs") eos))
#+END_SRC
