...
#+BEGIN_SRC emacs-lisp
  (use-package ivy-prescient
    ...
    (setq ivy-prescient-sort-commands
          '(:not swiper swiper-isearch ivy-switch-buffer counsel-M-x ivy-reverse-i-search))
    :config
...
Don't kill when deleting line or word
#+begin_src emacs-lisp
  ...
  (general-def 'ivy-minibuffer-map [remap backward-delete-word] 'ivy-backward-delete-word)
  (general-def "<C-backspace>" 'backward-delete-word)
  (general-def "<C-S-backspace>" 'backward-delete-line)
#+end_src
*** minibuffer
...
#+begin_src emacs-lisp
  ...
  (use-package rustic
    ...
    (lsp-rust-analyzer-diagnostics-disabled ["type-mismatch" "unresolved-import" "inactive-code"])
    :config
