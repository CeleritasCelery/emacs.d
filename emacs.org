...
#+BEGIN_SRC emacs-lisp
  (defvar $font-height (if ($dev-config-p) 130 100))
...
#+BEGIN_SRC emacs-lisp
  (use-package counsel
    ...
    :init
    (setq counsel-rg-base-command "rg -M 240 --with-filename --search-zip --no-heading --line-number --color never %s --path-separator / ."
...
#+BEGIN_SRC emacs-lisp
  (use-package evil
    ...
    (evil-search-module 'evil-search "match vim style search")
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'midnight-hook 'mu4e-update-mail-and-index)
#+END_SRC
    ...
    (when (and (equal user-login-name (nth 2 (file-attributes (vc-git-root default-directory) 'string)))
      ...
      (shell-command-to-string
       (apply 'format "git config --local user.name %s && git config --local user.email %s"
              ($user-credentials)))
      (shell-command-to-string "git config --local pull.rebase true")
...
#+BEGIN_SRC emacs-lisp
  (use-package elfeed
    ...
    (elfeed-feeds
     '("https://www.kill-the-newsletter.com/feeds/h1bnkuqulin0ilmn1ox6.xml" ;; James Clear 1-2-3
       "https://bzg.fr/index.xml" ;; Bastien Guerry (org maintainer)
       "https://sachachua.com/blog/feed/"
       "https://tratt.net/laurie/blog/entries.rss"
       ...
       "https://pcwalton.github.io/feed.xml"
       "https://irreal.org/blog/?feed=rss2"
       "https://probablydance.com/feed/"
       "https://www.tedinski.com/feed.xml"
       "https://rust-analyzer.github.io/feed.xml"
       "https://rustpython.github.io/feed.xml"
       "http://www.gingerbill.org/article/index.xml"
       "https://kill-the-newsletter.com/feeds/86edfwklno2p5s00.xml" ;; Mukul Rathi
       "https://kill-the-newsletter.com/feeds/cknhju58opgj9quw.xml" ;; Naval
       "https://kill-the-newsletter.com/feeds/j0mm7ibixsb7o20q.xml" ;; 4coder
       "https://kill-the-newsletter.com/feeds/0ublinkmgw51td1ix4k4.xml" ;; Dion Systems
       "https://fasterthanli.me/index.xml"
       "https://xkcd.com/atom.xml"
       "https://accidentallyquadratic.tumblr.com/rss"
       "https://www.kill-the-newsletter.com/feeds/b3qmtgoopyw6bd8fuhlg.xml" ;;CGP Grey newsletter
       "https://www.youtube.com/feeds/videos.xml?channel_id=UCsXVk37bltHxD1rDPwtNM8Q" ;; Kurzgesagt
       "http://nullprogram.com/feed"
       "https://reddit-top-rss.herokuapp.com/?subreddit=rust&averagePostsPerDay=1&view=rss"
       "https://reddit-top-rss.herokuapp.com/?subreddit=emacs&averagePostsPerDay=1&view=rss")))
#+END_SRC
...
#+begin_src emacs-lisp
  (unless ($dev-config-p)
    (use-package mu4e
      ...
      :general
      ('visual mu4e-headers-mode-map "!" 'mu4e-headers-mark-for-read)
      :commands mu4e
      :init
      (setq mu4e-get-mail-command "offlineimap"
            ...
            mu4e-sent-messages-behavior 'delete ;; IMAP will take care of moving sent messages
            mu4e-context-policy 'pick-first ;; Don't ask for context when I first start mu4e
            message-send-mail-function 'smtpmail-send-it
            smtpmail-smtp-service 587

            mu4e-maildir-shortcuts
            '(("/Gmail/[Gmail].All Mail" . ?a)
              ("/Pro/[Gmail].All Mail" . ?p)
              ("/Main/Notification" . ?z))
            mu4e-bookmarks
            '(("not maildir:/Gmail/[Gmail].Trash and not maildir:/Pro/[Gmail].Trash and not maildir:/Main/Trash and flag:unread" "Unread" ?u)
              ("maildir:/Gmail/INBOX or maildir:/Pro/INBOX or maildir:/Main/INBOX or maildir:/Main/Newsletter or maildir:/Main/Notification" "Inbox" ?i)
              ("date:today..now" "Today's messages" ?t)))
      :config
      (setq mu4e-contexts
            (list (make-mu4e-context
                   :name "gmail"
                   :match-func (apply-partially '$mu4e-check-context "/Gmail")
                   :vars '((user-mail-address . "t.macman@gmail.com")
                           (smtpmail-smtp-user . "t.macman@gmail.com")
                           (smtpmail-smtp-server . "smtp.gmail.com")
                           (user-full-name . "Mac Man")
                           (mu4e-trash-folder . "/Gmail/[Gmail].Trash")
                           (mu4e-refile-folder . "/Gmail/[Gmail].All Mail")))
                  (make-mu4e-context
                   :name "pro"
                   :match-func (apply-partially '$mu4e-check-context "/Pro")
                   :vars '((user-mail-address . "troyhinckley@gmail.com" )
                           (smtpmail-smtp-user . "troyhinckley@gmail.com")
                           (smtpmail-smtp-server . "smtp.gmail.com")
                           (user-full-name . "Troy Hinckley")
                           (mu4e-trash-folder . "/Pro/[Gmail].Trash")
                           (mu4e-refile-folder . "/Pro/[Gmail].All Mail")))
                  (make-mu4e-context
                   :name "main"
                   :match-func (apply-partially '$mu4e-check-context "/Main")
                   :vars '((user-mail-address . "comms@dabrev.com")
                           (smtpmail-smtp-user . "comms@dabrev.com")
  ...
  (defun $mu4e-check-context (maildir msg)
    (and msg
...
#+BEGIN_SRC emacs-lisp
  (use-package org-roam
    :init
    (setq org-roam-directory "~/Dropbox/org/coredump")
