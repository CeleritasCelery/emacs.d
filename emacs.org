  ...
  (with-eval-after-load 'compile
    (dolist (regex `((ipgen-gmake ,(err-rx bol "gmake: *** [" (group-n 1 (>= 10 any)) "] Error " num)
                     ...
                     (bman-verilog ,(err-rx bol "-I-:Error-" ->
                                            "\n-I-:" filename ", " line)
                                   1 2)
                     (bman-stage ,(err-rx bol "-" (or "E" "I") "-:" (opt spc) "FAILED:"
                                          -> (or ";" ":") " LOG " (opt ": ") filename)
                                 1)
                     ...
                     (simregress ,(err-rx spc+ "simregress invocation failed on " ->
                                 ...
                                 1)
                     (bman-generic-stage ,(err-rx bol "-E-:FAILED" spc+ fp
                                                  spc+ fp "  "
                                                  filename)
  ...
  (defvar $compilation-font-lock-keywords
    `((,($rx bol (opt "-I-:") spc*
      ...
      (,($rx bol (opt "-I-") spc*
             ...
             eol)
       1 'compilation-line-number)
      (,(rx bol (opt (or "-I-" "-I-:"))  (group (not (in "-")) (1+ (in alnum " \t_-"))) ":") 1 'font-lock-function-name-face)
      (,(rx bol (group "-I-") ) 1 'compilation-info prepend)
      (,(rx bol (opt "-I-:") (group (or "-I-" "Note-" "NOTE" "OVM_INFO"))) 1 'compilation-info prepend)
      (,(rx bol (opt "-I-:") (group (or "-E-" "-F-" "Error-" "Fatal-" "OVM_ERROR" "ERROR" "OVM_FATAL"))) 1 'compilation-error prepend)
      (,(rx bol (opt "-I-:") (group (or "-W-" "Warning-" "WARNING" "OVM_WARNING"))) 1 'compilation-warning prepend)))
