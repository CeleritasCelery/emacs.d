...
#+BEGIN_SRC emacs-lisp
  (use-package helm-projectile
    ...
    (with-eval-after-load 'helm
      (csetq helm-source-projectile-projects-actions
             (helm-make-actions
              "find file from project" #'$helm-projectile-find-file
    ...
    :config
    (defun $helm-projectile-switch-to-project (project)
      (let ((projectile-completion-system 'helm))
        (projectile-switch-project-by-name project)))
    (helm-projectile-define-key
     helm-projectile-projects-map
     (kbd "; f") '$helm-projectile-switch-to-project
     (kbd "; g") 'helm-projectile-vc
     (kbd "; s") 'helm-projectile-grep
     (kbd "; '") '$helm-projectile-pop-to-shell)
  ...
  directory pointing to the same file name"
    ...
    (when (>= (length head) 5)
      (let* ((parent (apply 'f-join head))
             ...
             (valid-paths (delete (car (file-expand-wildcards
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun $git-discard-ipgen-output ()
    ...
    (let ((models (file-expand-wildcards (expand-file-name "tools/ipgen/*/output" (vc-git-root default-directory)))))
      ...
      (cl-loop for model in models
               do (shell-command-to-string (concat "git checkout HEAD -- " model)))
      (message "done")))
#+END_SRC
