...
** Helm
I almost completely use Ivy now, but just have Helm for my custom process command.
...
#+BEGIN_SRC emacs-lisp
  ...
  ($leader-set-key "fE" '$run-last-ediff)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package tcl-mode
    ...
    :config
    (add-to-list 'tcl-proc-list "iProc")
    (add-to-list 'tcl-proc-list "iTopProc")
    (add-to-list 'tcl-keyword-list "iProc")
    (add-to-list 'tcl-keyword-list "iTopProc")
    (add-to-list 'tcl-typeword-list "iProcsForModule")
    (setq tcl-builtin-list (append tcl-builtin-list '("iWrite" "iRead" "iApply" "iCall" "iTake" "iNote")))
    (tcl-set-proc-regexp)
