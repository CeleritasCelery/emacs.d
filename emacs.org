...
#+BEGIN_SRC emacs-lisp
  (defvar $font-height (if ($dev-config-p) 120 90))
  (set-face-attribute 'default nil :family "Source Code Pro" :height $font-height)
...
#+BEGIN_SRC emacs-lisp
  (use-package comint
    ...
    (:keymaps 'comint-mode-map
     [remap comit-previous-input] 'comint-previous-matching-input-from-input
