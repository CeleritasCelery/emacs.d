...
#+BEGIN_SRC emacs-lisp
  (defvar $site (intern-soft (getenv "EC_SITE"))
    "Current EC site")
#+END_SRC
** Package Manager
...
#+BEGIN_SRC emacs-lisp
  (use-package helpful
    ...
    (setq find-function-C-source-directory
          "/nfs/pdx/home/tjhinckl/custom/emacs-mirror/src"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package counsel
    ...
    (setq counsel-git-cmd "/usr/intel/bin/git ls-files --full-name --"
          ...
          counsel-async-filter-update-time 200000)
    :config
...
#+BEGIN_SRC emacs-lisp
  (use-package ivy-posframe
    ...
    :after ivy
    :config
    (setf (alist-get 'swiper ivy-display-functions-alist) 'ivy-display-function-fallback)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun $buffer-in-project (buf project only-files)
    (with-current-buffer (cdr buf)
      (and (equal ($get-project-root) project)
           (or (null only-files)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun $change-model ()
    ...
    (let ((default-directory
            (if (eq site 'pdx)
                "/nfs/pdx/disks/sdg74_1172/tjhinckl/workspace/"
              "/nfs/sc/disks/sdg74_1185/tjhinckl/workspace/")))
      (counsel-find-file)))
...
#+BEGIN_SRC emacs-lisp
  (csetq org-agenda-todo-ignore-scheduled 'future
         ...
         org-agenda-custom-commands '(("f" "full" tags-todo "mdf|snr|gen|int|val")
...
#+BEGIN_SRC emacs-lisp
  (use-package auto-capitalize
    :hook org-mode
    :init
    (setq auto-capitalize-words `("I" "English" "MDF" "UPF" "IPGen" "SNR" )))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package smart-dash
    :hook perl-mode
    :init
    (setq smart-dash-c-modes '(perl-mode)))
#+END_SRC
