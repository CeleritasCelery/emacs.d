...
#+BEGIN_SRC emacs-lisp
  (use-package evil-anzu
    ...
    :straight
    (evil-anzu
     :type git :host github :repo "CeleritasCelery/evil-anzu"
     :upstream (:host github
...
#+BEGIN_SRC emacs-lisp
  (delete "/p/hdk/rtl/proj_tools/proj_binx/shdk74/latest" exec-path)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun $find-generic-bman-log (file)
    (car (file-expand-wildcards (format "target/log/*.%s.log" file))))
