...
#+BEGIN_SRC emacs-lisp
  (csetq prettify-symbols-unprettify-at-point t
         ...
         (defun $prettify-symbols-all-p (start end _match)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun $show-and-copy-buffer-filename (arg)
    ...
    (let ((file-name (or (buffer-file-name)
                         ...
                         default-directory)))
      (if file-name
          (message (kill-new (if (eq (null arg) (f-parent-of-p "~/workspace/" file-name))
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'verilog-mode-hook '$verilog-compose-xor)
#+END_SRC
