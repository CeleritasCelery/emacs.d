...
#+END_SRC
  ...
  (defhydra lisp-quick (:pre (progn (require 'evil-cleverparens)
    ...
    ;; ("j" lisp-state-next-closing-paren "next" :exit nil)
    ;; ("k" lisp-state-prev-opening-paren "prev" :exit nil)
    ;; ("h" sp-backward-symbol "up" :exit nil)
    ;; ("l" sp-forward-symbol "down" :exit nil)
    ("v" evil-visual-char "visual" :exit nil)
    ("I" lispyville-insert-at-beginning-of-list "insert list")
    ("A" lispyville-insert-at-end-of-list "append list")
    ("O" lispyville-open-above-list "open above")
    ("o" lispyville-open-below-list "open below")
    ("J" lispy-join "join")
    ("r" sp-raise-sexp "raise")
    ("R" lispyville-raise-list "raise list")
